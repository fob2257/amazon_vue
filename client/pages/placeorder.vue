    ...
    <div class="container-fluid">
      <div class="shipping-address">
                        ...
                        <fieldset>
                          ...
                          <div class="a-spacing-mini wednesday">
                            ...
                            <input
                              type="radio"
                              name="order0"
                              @change="handleDelivery('normal')"
                              :checked="true"
                            />
                            <span class="a-radio-label">
                              <span class="a-color-success">
                                <strong>
                                  Averages {{ shipmentOptions.normal.days }} business days
                                </strong>
                              </span>
                              <br />
                              <span class="a-color-secondary">
                                ${{ shipmentOptions.normal.price }}&nbsp;-&nbsp;Standard
                                International Shipping - No Tracking
                              </span>
                            </span>
                          </div>
                          <br />
                          <div class="a-spacing-mini tuesday">
                            ...
                            <input
                              type="radio"
                              name="order0"
                              @change="handleDelivery('fast')"
                            />
                            <span class="a-radio-label">
                              <span class="a-color-success">
                                <strong>
                                  Averages {{ shipmentOptions.fast.days }} business days
                                </strong>
                              </span>
                              <br />
                              <span class="a-color-secondary">
                                ${{ shipmentOptions.fast.price }}&nbsp;-&nbsp;Shipping
                              </span>
                            </span>
                          </div>
                        </fieldset>
                  ...
                  <div class="a-row">
                    ...
                    <div class="order-summary" style="font-size: 12px">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6 text-right">USD ${{ shipment.price }}</div>
                      </div>
                      <div class="row mt-2">
                ...
                <div class="a-box-inner">
                  ...
                  <div class="a-size-mini">
                    <div class="a-row a-spacing-mini mb-1">
                      Please note that your country may charge import duties, taxes and
        ...
        <div class="a-row a-spacing-small a-spacing-top-small">
          ...
          <p class="a-color-secondary a-size-mini">
            For an item sold by Amazon.com: When you click the "Place your order" button,
            we'll send you an email message acknowledging receipt of your order. Your
            contract to purchase an item will not be complete until we send you an email
          ...
          <div class="a-color-secondary a-size-mini">
            <p class="a-color-secondary a-size-mini">
              Within 30 days of delivery, you may return new, unopened merchandise in its
              original condition. Exceptions and restrictions apply. See Amazon.com's
              <a href="#">Returns Policy</a>
              <br />
              <br />Go to the <a href="#">Amazon.com homepage</a> without completing your
              order.
            </p>
          </div>
        </div>
...
export default {
  ...
  async asyncData({ $axios, store }) {
    try {
      const [{ shipmentOptions }, { shipment }] = await Promise.all([
        ...
        $axios.$post('/api/shipment', { shipment: 'normal' }),
      ]);

      // mapping data to state
      store.commit('setShipment', { ...shipment });

      return { shipmentOptions, shipment };
    } catch (error) {
      console.error(error);
    }
  },
  ...
  methods: {
    async handleDelivery(option) {
      try {
        const { shipment } = await this.$axios.$post('/api/shipment', {
          shipment: option,
        });
