      ...
      <div class="row">
        <div class="col-lg-4 col-md-5 col-sm-12">
          ...
          <a href="#" class="a-color-base">
            <h2 v-if="reviews.length === 1">{{ reviews.length }} customer review</h2>
            <h2 v-else>{{ reviews.length }} customer reviews</h2>
          </a>
          ...
          <div class="cr-widget-focalreviews">
            <div class="card-padding">
              <div class="review-header">
                <h3>
                  <span class="a-size-base" v-if="reviews.length === 1">
                    Showing 1-8 of {{ reviews.length }} review
                  </span>
                  <span class="a-size-base" v-else>
                    Showing 1-8 of {{ reviews.length }} reviews
                  </span>
                </h3>
              </div>
              ...
              <div class="review-body" v-for="review in reviews" :key="review._id">
                <div class="genome-widget">
                  <a href="#">
                    ...
                    <div class="profile-content">
                      <span class="a-profile-name" v-if="review.user">
                        {{ review.user.name }}
                      </span>
                    </div>
                  </a>
                ...
                <div class="a-row">
                  <!-- Review Star -->
                  <a href="#">
                    <i class="fas fa-star" v-for="idx in review.rating" :key="idx" />
                  </a>
                  <span class="a-letter-space"></span>
                  <!-- Review Headline -->
